...
**One check cannot run here.** The disclosure scan reads a pattern this
repository does not contain, so in a clone without it the scan skips loudly
and returns success. Continuous integration therefore enforces the code gate
